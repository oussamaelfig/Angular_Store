            ...
            <div class="accordion accordion-flush" id="questions">
                ...
                <div class="accordion-item">
                    ...
                    <div id="question-one" class="accordion-collapse collapse" data-bs-parent="#questions">
                        <div class="accordion-body">Passer une commande sur COMPECOM est un jeu d’enfant. Ajoutez
                            ...
                            expédions les commandes en ligne partout au Canada et États Unis, et les frais d’expéditions
                ...
                <div class="accordion-item">
                    ...
                    <div id="question-two" class="accordion-collapse collapse" data-bs-parent="#questions">
                        <div class="accordion-body">Si vous avez acheté votre article en magasin, en ligne ou avec
                            l’option Réservez et ramassez, vous pouvez le retourner ou l’échanger dans n’importe quel
                ...
                <div class="accordion-item">
                    ...
                    <div id="question-three" class="accordion-collapse collapse" data-bs-parent="#questions">
                        <div class="accordion-body">Notre objectif est de vous faire parvenir vos articles rapidement.
                            Nous faisons appel à différentes compagnies de transport, en fonction de la taille de votre
                ...
                <div class="accordion-item">
                    ...
                    <div id="question-four" class="accordion-collapse collapse" data-bs-parent="#questions">
                        <div class="accordion-body">Vous pouvez communiquer avec notre équipe du Service à la clientèle
                            (appelez le 1-866-237-8289) et si vous êtes admissible, nous entreprendrons pour vous le
                            suivi de votre commande avec le fournisseur de services d’expédition applicable.
                            <h4> Remarque :</h4>
                            Les réclamations doivent être faites au plus tard 90 jours après l’expédition de votre
                            commande.
                            Postes Canada n’ouvrira pas de réclamation en votre nom, la réclamation doit provenir de
